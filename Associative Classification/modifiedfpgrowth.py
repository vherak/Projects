            ...
            for antecedent in itertools.combinations(itemset, i):
                ...
                if len(consequent) == 1 and consequent[0] in class_label:
                    if antecedent in patterns:
                        ...
                        if confidence >= confidence_threshold:
                            CARs[antecedent] = (consequent, confidence)
    return CARs
...
# def generate_association_rules(patterns, confidence_threshold,total_transactions):
#     """
#     Given a set of frequent itemsets, return a dict
#     of association rules in the form
#     {(left): ((right), confidence)}
...
#                     lower_support = patterns[antecedent]
#                     confidence = float(upper_support) / lower_support
#                     support = upper_support/total_transactions
#                     if confidence >= confidence_threshold:
#                         rules[antecedent] = (consequent, confidence,support)
...
if __name__ == "__main__":
    ...
    # dataset imports
    # breast_cancer = preprocess_data("C:/Users/Cheryl Neoh/Desktop/SEMESTER 2 2020/FIT3162 FYP 2/FIT3162-WhatOnEarth/Datasets/breast-cancer.data", missing_value_symbol='?')
    # primary_tumour = preprocess_data("C:/Users/Cheryl Neoh/Desktop/SEMESTER 2 2020/FIT3162 FYP 2/FIT3162-WhatOnEarth/Datasets/primary-tumor.csv")
    ...
    # car = preprocess_data("C:/Users/Cheryl Neoh/Desktop/SEMESTER 2 2020/FIT3162 FYP 2/FIT3162-WhatOnEarth/Datasets/car.data")
